...
import com.sfl.tms.service.language.exception.LanguageExistByLangException
...
class LanguageController {
    ...
    fun create(@RequestParam("lang") lang: String): ResponseEntity<ResultModel<out AbstractApiModel>> = try {
        lang
